# M12 -> VKD3D-Proton Graphics Stack Migration
...
6. **32-bit D3D12 out of scope** — M12 is 64-bit only. Its readiness gate
...
application. M12 resolves to `vkd3d-proton`, selects the real
...
and the launch doctor reports `Ready for M12 via vkd3d-proton` with no blockers
or warnings.
...
Elden Ring app `1245620` was then launched through the offline M12 route. The
